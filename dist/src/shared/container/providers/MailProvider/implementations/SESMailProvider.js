...
var SESMailProvider = /** @class */ (function () {
    ...
    SESMailProvider.prototype.sendMail = function (to, subject, variables, path) {
        return __awaiter(this, void 0, void 0, function () {
            var templateFieContent, templateParse, templateHTML;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        templateFieContent = fs_1.default.readFileSync(path).toString("utf-8");
                        templateParse = handlebars_1.default.compile(templateFieContent);
                        templateHTML = templateParse(variables);
                        return [4 /*yield*/, this.client.sendMail({
                                to: to,
                                from: "Rentx <contact@alvarosstsantos.com>",
                                subject: subject,
                                html: templateHTML,
                            })];
                    case 1:
