...
var SendForgotPasswordMailUseCase = /** @class */ (function () {
    function SendForgotPasswordMailUseCase(usersRepository, usersTokensRepository, dayjsDateProvider, mailProvider) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!user) {
                            throw new AppErrors_1.AppError("user does not exists");
                        }
                        token = uuid_1.v4();
