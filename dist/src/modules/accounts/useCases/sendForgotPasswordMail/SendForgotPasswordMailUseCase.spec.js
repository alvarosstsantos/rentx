...
describe("Send Forgot Mail", function () {
    ...
    it("should be able to send a forgot password mail to user", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, sendForgotPasswordMailUseCase.execute("zafik@lour.mu")];
                case 2:
                    _a.sent();
    ...
    it("should not be able to send email if user does not exists", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, expect(sendForgotPasswordMailUseCase.execute("wac@jussogre.sl")).rejects.toEqual(new AppErrors_1.AppError("user does not exists"))];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it("should be able to create an users token", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    generateTokenMail = spyOn(usersTokensRepositoryInMemory, "create");
                    return [4 /*yield*/, usersRepositoryInMemory.create({
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, sendForgotPasswordMailUseCase.execute("bekzomki@mu.sx")];
                case 2:
                    _a.sent();
