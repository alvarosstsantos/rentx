...
describe("Authenticate User", function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, expect(authenticateUserUseCase.execute({
                    ...
                    })).rejects.toEqual(new AppErrors_1.AppError("Email or password incorrect!"))];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it("Should not be able to authenticate a user with wrong password", function () { return __awaiter(void 0, void 0, void 0, function () {
        var user;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
