...
var CreateUserController = /** @class */ (function () {
    ...
    CreateUserController.prototype.handle = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, name, email, driver_license, password, createUserUseCase;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = request.body, name = _a.name, email = _a.email, driver_license = _a.driver_license, password = _a.password;
