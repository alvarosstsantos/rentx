...
var RefreshTokenUseCase = /** @class */ (function () {
    ...
    RefreshTokenUseCase.prototype.execute = function (token) {
        return __awaiter(this, void 0, void 0, function () {
            var secret_token, expires_in_token, secret_refresh_token, expires_in_refresh_token, expires_refresh_token_days, _a, sub, email, user_id, userToken, refresh_token, refresh_token_expires_date, newToken;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        secret_token = auth_1.default.secret_token, expires_in_token = auth_1.default.expires_in_token, secret_refresh_token = auth_1.default.secret_refresh_token, expires_in_refresh_token = auth_1.default.expires_in_refresh_token, expires_refresh_token_days = auth_1.default.expires_refresh_token_days;
                        _a = jsonwebtoken_1.verify(token, secret_refresh_token), sub = _a.sub, email = _a.email;
                        user_id = sub;
                        return [4 /*yield*/, this.usersTokensRepository.findByUserIdAndRefreshToken(user_id, token)];
                    case 1:
                        userToken = _b.sent();
                        if (!userToken) {
                            throw new AppErrors_1.AppError("refresh token does not exists");
                        }
                    ...
                    case 3:
                        _b.sent();
                        newToken = jsonwebtoken_1.sign({}, secret_token, {
                            subject: user_id,
