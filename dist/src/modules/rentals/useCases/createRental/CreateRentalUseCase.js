...
var CreateRentalUseCase = /** @class */ (function () {
    ...
    CreateRentalUseCase.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var minRentHours, carUnavailable, rentalOpenToUser, dateNow, compare, rental;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (carUnavailable) {
                            throw new AppErrors_1.AppError("car is unavailable for rent");
                        }
                        return [4 /*yield*/, this.rentalsRepository.findOpenRentalByUser(user_id)];
                    case 2:
                        rentalOpenToUser = _b.sent();
                        if (rentalOpenToUser) {
                            throw new AppErrors_1.AppError("there is already a rental open for this user");
                        }
                        ...
                        if (compare < minRentHours) {
                            throw new AppErrors_1.AppError("invalid return date");
                        }
