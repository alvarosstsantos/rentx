...
describe("Create Rental", function () {
            ...
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, expect(createRentalUseCase.execute({
                            ...
                            car_id: "12121213",
                            expected_return_date: dayAdd24Hours,
                        })).rejects.toEqual(new AppErrors_1.AppError("there is already a rental open for this user"))];
                case 3:
                    _a.sent();
                    return [2 /*return*/];
            }
            ...
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, expect(createRentalUseCase.execute({
                            ...
                            car_id: car.id,
                            expected_return_date: dayAdd24Hours,
                        })).rejects.toEqual(new AppErrors_1.AppError("car is unavailable for rent"))];
                case 3:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it("Should not be able to create a new rental for less than 24hours return time", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, expect(createRentalUseCase.execute({
                    ...
                    })).rejects.toEqual(new AppErrors_1.AppError("invalid return date"))];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
