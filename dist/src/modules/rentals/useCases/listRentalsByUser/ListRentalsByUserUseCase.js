...
var ListRentalsByUserUseCase = /** @class */ (function () {
    function ListRentalsByUserUseCase(rentalsRepository) {
        this.rentalsRepository = rentalsRepository;
    }
    ListRentalsByUserUseCase.prototype.execute = function (user_id) {
        return __awaiter(this, void 0, void 0, function () {
            var rentals;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.rentalsRepository.findByUser(user_id)];
                    case 1:
                        rentals = _a.sent();
