            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        minimum_daily = 1;
                        if (!rental) {
                            throw new AppErrors_1.AppError("rental does not exists");
                        }
                        dateNow = this.dateProvider.dateNow();
                        daily = this.dateProvider.compareInDays(rental.start_date, dateNow);
                        if (daily <= 0) {
                            daily = minimum_daily;
                        }
                        delay = this.dateProvider.compareInDays(rental.expected_return_date, dateNow);
                        total = 0;
                        if (delay > 0) {
