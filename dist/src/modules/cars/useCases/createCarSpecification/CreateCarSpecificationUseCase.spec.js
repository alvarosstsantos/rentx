...
describe("Create Car Specification", function () {
    ...
    it("Should not be able to add a new specification to the a non-existing car", function () { return __awaiter(void 0, void 0, void 0, function () {
        var car_id, specifications_id;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    car_id = "123";
                    specifications_id = ["qwert"];
                    return [4 /*yield*/, expect(createCarSpecificationUseCase.execute({
                            car_id: car_id,
                            specifications_id: specifications_id,
                        })).rejects.toEqual(new AppErrors_1.AppError("car does not exists"))];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
