...
describe("Create Category", function () {
    ...
    it("should not be able to create a new category with name already taken", function () { return __awaiter(void 0, void 0, void 0, function () {
        var category;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, expect(createCategoryUseCase.execute(category)).rejects.toEqual(new AppErrors_1.AppError("category already exists"))];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
