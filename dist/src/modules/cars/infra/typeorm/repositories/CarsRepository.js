...
var CarsRepository = /** @class */ (function () {
    ...
    CarsRepository.prototype.create = function (_a) {
        var name = _a.name, description = _a.description, daily_rate = _a.daily_rate, license_plate = _a.license_plate, fine_amount = _a.fine_amount, brand = _a.brand, category_id = _a.category_id, specifications = _a.specifications, id = _a.id;
    ...
    CarsRepository.prototype.findByLicensePlate = function (license_plate) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.repository.findOne({ license_plate: license_plate })];
                    case 1:
                        car = _a.sent();
                        return [2 /*return*/, car];
                }
