...
let CreateCarUseCase = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  async execute({
    ...
    const carAlreadyExists = await this.carsRepositoy.findByLicensePlate(license_plate);

    if (carAlreadyExists) {
      throw new _AppErrors.AppError("car already exists");
    }
